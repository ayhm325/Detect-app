...
export default function PatientResultsPage() {
  ...
  const [reports, setReports] = useState([
    {
      ...
      priority: "عادي",
      aiSummary: "النتائج طبيعية، لا توجد مؤشرات لأي مشاكل في الرئتين أو القفص الصدري.",
      findings: [
        { text: "الرئتان نظيفتان وخاليتان من أي التهابات", type: "normal" },
        { text: "القلب بحجم طبيعي", type: "normal" },
        { text: "لا توجد كسور في القفص الصدري", type: "normal" }
      ],
      images: ["/icons/patient-placeholder.png"],
      notes: "يُنصح بإعادة الفحص بعد 6 أشهر للمتابعة الدورية"
    },
    {
      id: 2,
      title: "تحليل دم شامل",
  ...
  const stats = [
    ...
    {
      title: "الجاهزة",
      value: reports.filter(r => r.status === "جاهز").length,
      icon: FaCheckCircle,
      color: "bg-green-500",
    ...
    {
      title: "قيد المراجعة",
      value: reports.filter(r => r.status === "قيد المراجعة").length,
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 p-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">التقارير الطبية</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">عرض وإدارة جميع تقاريرك ونتائج الفحوصات</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-slate-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="بحث بالعنوان أو الطبيب..."
                value={searchQuery}
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="Laboratory">تحاليل مخبرية</option>
                <option value="ECG">تخطيط القلب</option>
              </select>
            </div>
            <div className="relative">
              <FaFilter className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
        ...
        {filteredReports.length === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-12 text-center border border-gray-200 dark:border-slate-700">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">لا توجد تقارير</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-4">
                  <div className="flex items-start gap-2">
                    <span className="text-blue-600 dark:text-blue-400 font-bold text-sm">AI ملخص:</span>
                  </div>
                ...
                {/* Findings */}
                <div className="mb-4">
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2 text-sm">النتائج:</h4>
                ...
                {report.notes && (
                  <div className="bg-gray-50 dark:bg-slate-900 rounded-lg p-3 mb-4">
                    <p className="text-sm font-medium text-gray-900 dark:text-white mb-1">ملاحظات:</p>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
                  <h4 className="font-bold text-blue-900 dark:text-blue-300 mb-2">ملخص التحليل الذكي</h4>
                  <p className="text-gray-700 dark:text-gray-300">{selectedReport.aiSummary}</p>
                </div>

                {/* Findings */}
                <div className="mb-6">
                  <h4 className="font-bold text-gray-900 dark:text-white mb-3">النتائج التفصيلية:</h4>
                  <div className="space-y-2">
                ...
                {selectedReport.images.length > 0 && (
                  <div className="mb-6">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-3">الصور الطبية:</h4>
                ...
                <div className="bg-gray-50 dark:bg-slate-900 rounded-lg p-4">
                  <h4 className="font-bold text-gray-900 dark:text-white mb-2">معلومات الطبيب:</h4>
                  <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                    <p><span className="font-medium">الطبيب:</span> {selectedReport.doctor}</p>
                    <p><span className="font-medium">المنشأة:</span> {selectedReport.facility}</p>
                    <p><span className="font-medium">التاريخ:</span> {selectedReport.date} - {selectedReport.time}</p>
                    {selectedReport.notes && (
                      <p className="mt-2 pt-2 border-t border-gray-200 dark:border-slate-700">
                        <span className="font-medium">ملاحظات:</span> {selectedReport.notes}
                      </p>
                    )}
                  </div>
                </div>
