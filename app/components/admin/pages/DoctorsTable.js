      ...
      <table className="min-w-full bg-white rounded-2xl shadow-xl border border-zinc-200">
        <thead>
          <tr className="bg-linear-to-r from-yellow-100 via-red-100/40 to-white">
            ...
            <th className="py-3 px-4 text-zinc-700 font-bold">التخصص</th>
        ...
        <tbody>
          {[{
            id: 1, name: "د. محمد سالم", specialty: "أشعة", email: "msalem@hospital.com"
          }, {
            id: 2, name: "د. ليلى حسن", specialty: "صدرية", email: "lhasan@hospital.com"
          }, {
            id: 3, name: "د. سامي يوسف", specialty: "عظام", email: "syousef@hospital.com"
          }].map((doctor, i) => (
            <tr key={doctor.id} className="border-t border-zinc-100 hover:bg-yellow-50/40">
              <td className="py-2 px-4 text-center font-bold">{i+1}</td>
              <td className="py-2 px-4 text-center flex items-center gap-2 justify-center"><FaUserMd className="text-yellow-600" />{doctor.name}</td>
              <td className="py-2 px-4 text-center">{doctor.specialty}</td>
              <td className="py-2 px-4 text-center">{doctor.email}</td>
