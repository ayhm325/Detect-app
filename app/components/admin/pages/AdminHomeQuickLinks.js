...
export default function AdminHomeQuickLinks() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mt-12">
      <a href={`${basePrefix}/admin/dashboard`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-yellow-100 border-2 border-yellow-200 shadow group transition">
      ...
      <a href={`${basePrefix}/admin/analysis`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-blue-100 border-2 border-blue-200 shadow group transition">
      ...
      <a href={`${basePrefix}/admin/doctors`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-red-100 border-2 border-red-200 shadow group transition">
      ...
      <a href={`${basePrefix}/admin/patients`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-yellow-50 border-2 border-yellow-300 shadow group transition">
      ...
      <a href={`${basePrefix}/admin/chat`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-red-50 border-2 border-red-300 shadow group transition">
      ...
      <a href={`${basePrefix}/admin/settings`} className="flex flex-col items-center p-4 rounded-2xl bg-white/80 hover:bg-yellow-50 border-2 border-yellow-400 shadow group transition">
