...
export const glassContainer = 'w-full card-glass p-6 sm:p-10 max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl border border-white/10 backdrop-blur-xl bg-white/10';
...
export const btnPrimary = 'w-full px-8 py-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold text-lg shadow-lg transition-all hover:shadow-emerald-500/30 hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-3';
