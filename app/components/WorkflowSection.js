  ...
  return (
    <section className="relative w-full py-20 sm:py-24 bg-linear-to-tr from-(--color-dark-100) via-(--color-background) to-(--color-bright-100) text-(--ui-foreground) overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
          ...
          <defs>
            ...
            >
              <stop
                offset="0%"
                style={{
                  stopColor: "var(--color-bright-500)",
                  stopOpacity: 0.8,
                }}
              />
              <stop
              ...
              <stop
                offset="100%"
                style={{ stopColor: "var(--color-dark-500)", stopOpacity: 0.8 }}
              />
            </linearGradient>
          </defs>
        ...
        {/* Glowing Orbs */}
        <div
          className="absolute top-10 left-10 w-100 h-100 bg-(--ui-warning)/15 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute bottom-10 right-10 w-112.5 h-112.5 bg-(--ui-danger)/12 rounded-full blur-3xl animate-pulse"
