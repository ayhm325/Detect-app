...
export default function HoloButton({ variant = 'primary', className = '', children, ...props }) {
  ...
  const ghost = 'bg-transparent text-gray-800 hover:bg-black/5 dark:text-gray-200';
  const outline = 'bg-transparent border border-gray-200 text-gray-800 hover:bg-gray-50';
