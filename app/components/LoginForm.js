...
export default function LoginForm() {
  ...
  const withLocale = (path) => {
    ...
    return base.startsWith("/en") || base.startsWith("/ar")
      ? base
      : `/${locale}${base === "/" ? "" : base}`;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      switch (data.user.role) {
        case "doctor":
          window.location.href = `${basePath}/doctor/dashboard`;
          break;
        case "patient":
      ...
      <div className="relative z-10 w-full max-w-md flex items-center justify-center min-h-[80vh] mx-auto">
        ...
        >
          ...
          <div className="mb-8 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <button
                ...
                className={`${backHomeBtn} ${authIcon}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute right-4 top-1/2 -translate-y-1/2 ${authIcon} hover:${authIcon} transition-colors`}
                >
                  {showPassword ? (
          ...
          {error && (
            <div
              role="alert"
              className={`bg-green-100/50 backdrop-blur border-2 border-green-800 rounded-xl p-3 ${authText} text-base flex items-center gap-3 mt-4`}
            >
          ...
          >
            {loading ? (
              <span className="flex items-center justify-center gap-2">
                <span
                  className={`inline-block w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin ${authIcon}`}
                />
          ...
          <div className="flex flex-col gap-3 text-center text-sm mt-6">
            <Link
              ...
              className={`${authIcon} hover:${authIcon} font-semibold`}
            >
              {t("auth.login.forgot")}
            </Link>
