        ...
        <tbody>
          {patients.map((p) => (
            ...
            >
              ...
              <td>{p.status}</td>
              <td>
                <button className="text-(--ui-info) hover:underline">
                  View Profile
                </button>
              </td>
            </tr>
