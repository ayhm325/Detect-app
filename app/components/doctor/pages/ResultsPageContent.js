  ...
  const mockScans = [
    {
      ...
      annotations: [
        {
          text: t("mock.scan101.annotation1.text"),
          position: t("mock.scan101.annotation1.position"),
        },
        {
          text: t("mock.scan101.annotation2.text"),
          position: t("mock.scan101.annotation2.position"),
        },
      ],
    },
    {
