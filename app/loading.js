    ...
    <div className="min-h-screen flex items-center justify-center bg-(--ui-surface) text-(--ui-foreground)">
      <div className="text-center">
        ...
        <div className="relative w-32 h-32 mx-auto mb-8">
          ...
          <div className="absolute inset-0 brand-gradient rounded-full animate-spin" style={{ animationDuration: '3s' }}>
            <div className="absolute inset-2 bg-(--ui-surface) rounded-full" />
          </div>
          <div className="absolute inset-0 flex items-center justify-center">
            <svg className="w-16 h-16 text-(--ui-ring)" fill="none" viewBox="0 0 24 24" stroke="currentColor">
